...
Write-Host "  OK  portfolio.csv loaded from input directory"
Write-Host "  OK  3 Vasicek scenarios x 24 months loaded from riskfactors CSVs"
Write-Host "  OK  runs.json defines 2 runs with different contract/scenario slices"
Write-Host "  OK  Per-contract x per-scenario PVs in *_fact_results_long.csv"
Write-Host "  OK  Per-contract statistics in *_contract_summary.csv"
Write-Host "  OK  Metadata join ready: contract_metadata.csv -> ContractId"
