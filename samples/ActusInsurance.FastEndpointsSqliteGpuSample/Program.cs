...
// PAM Monte Carlo engines for real ACTUS calculations
builder.Services.AddKeyedSingleton<ICalculationEngine>("pam_cpu", (sp, key) => new PamMonteCarloEngine(preferGpu: false));
builder.Services.AddKeyedSingleton<ICalculationEngine>("pam_gpu", (sp, key) => new PamMonteCarloEngine(preferGpu: true));
